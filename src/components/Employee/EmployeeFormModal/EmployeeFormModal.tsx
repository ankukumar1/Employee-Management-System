      ...
      <div className="relative w-full max-w-2xl rounded-3xl bg-white shadow-2xl">
        ...
        <form onSubmit={onSubmit} className="grid gap-5 px-6 py-6">
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <label className="flex flex-col gap-2 text-sm font-medium text-slate-700">
              ...
              <div className="relative">
                <input
                  ...
                  required={!isEdit}
                  className="w-full rounded-2xl border border-slate-200 px-4 py-3 pr-12 text-sm font-normal text-slate-800 shadow-inner focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-100"
                />
                <span className="pointer-events-none absolute inset-y-0 right-4 flex items-center text-slate-400">
                  <svg aria-hidden="true" viewBox="0 0 20 20" className="h-4 w-4" fill="currentColor">
                    <path d="M10 2a4 4 0 00-4 4v2H5a2 2 0 00-2 2v6a2 2 0 002 2h10a2 2 0 002-2v-6a2 2 0 00-2-2h-1V6a4 4 0 00-4-4zm-2 6V6a2 2 0 114 0v2H8zm2 4a1.5 1.5 0 110-3 1.5 1.5 0 010 3z" />
                  </svg>
                </span>
              </div>
            </label>
            ...
            <p className="sm:col-span-2 text-xs font-normal text-slate-400">
              Passwords are temporary and prompt employees to create a new one during their first login.
            </p>
          </div>
